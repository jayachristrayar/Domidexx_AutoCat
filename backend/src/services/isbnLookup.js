...
For "subjects": list the book's actual subject headings -- the real topics a library catalogue would assign, drawn from the publisher description, table of contents, or an existing library/bookseller subject listing found in the research. Do not list every concept, keyword, or theoretical term merely mentioned in passing, and do not derive a subject from a word appearing only in the title/subtitle. There is no fixed count to hit either way -- list as many distinct, genuinely evidenced subjects as the research actually supports (that may be 3, or it may be 15+ for a book that covers many topics), and no more than that. Order the list from most to least central to the book. Do not repeat the same heading with different wording.
